...
<p align="left"> <img src="https://komarev.com/ghpvc/?username=Elara-Discord-Bots&label=Profile%20views&color=0e75b6&style=flat" alt="Elara-Discord-Bots" />

#### About Me
- My name is SUPERCHIEFYT (or `CHIEF`/`Super`)
...
➡ I've developed bots with the following features: `Moderation`, `AutoModeration`, `Utilities`, `Auto Responders`, `Giveaways`, `Custom Commands`, `Social Media Announcements (YouTube, BlueSky, Threads, Twitch, Twitter, Reddit)`, `Custom Embeds`, `Logging`, `Currency`, `Image-related commands` and `Welcome/Leave Messages/Roles`<br>
